...
<div class="max-w-3xl mx-auto my-8 px-4">
    ...
    <div class="flex flex-col justify-between md:flex-row sm:flex-col items-center mb-6">
        ...
        <img src="https://yavuzceliker.github.io/sample-images/image-600.jpg" alt="Book Cover"
    ...
    <div class="mb-6">
        ...
        <!-- Email address -->
        <input type="email" placeholder="Email address" class="w-full p-3 mb-4 rounded-lg border border-gray-300">
    </div>
    ...
    <div class="mb-6">
        ...
        <input id="due-date-picker" name="due_date" class="w-full p-3 rounded-lg border border-gray-300"
