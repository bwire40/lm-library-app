    ...
    <div class="max-w-4xl mx-auto mt-4 mb-4">
        ...
        <div class="relative mb-6">
            ...
            <svg class="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-4.35-4.35m1.29-5.35A7.5 7.5 0 1110.5 3 7.5 7.5 0 0118 10.5z"/>
            </svg>
        </div>
        ...
        <div>
            @foreach ([
                ['title' => 'A Promised Land', 'author' => 'Barack Obama', 'image' => ' https://yavuzceliker.github.io/sample-images/image-12.jpg'],
                ['title' => 'Becoming', 'author' => 'Michelle Obama', 'image' => ' https://yavuzceliker.github.io/sample-images/image-14.jpg'],
                ['title' => 'Where the Crawdads Sing', 'author' => 'Delia Owens', 'image' => ' https://yavuzceliker.github.io/sample-images/image-16.jpg'],
                ['title' => 'Little Fires Everywhere', 'author' => 'Celeste Ng', 'image' => ' https://yavuzceliker.github.io/sample-images/image-18.jpg'],
                ['title' => 'Educated', 'author' => 'Tara Westover', 'image' => ' https://yavuzceliker.github.io/sample-images/image-20.jpg'],
            ] as $book)
