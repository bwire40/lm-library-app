...
<button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
    class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 w-fit md:mx-3 my-3
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="eg. The Holy Spirit" required>
                        ...
                        <div class="w-full">
                            <label for="year_of_publishing" class="block mb-2   text-black dark:text-white">Year of
                                Publishing</label>
